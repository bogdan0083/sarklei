...
$(document).ready(function(e) {
    ...
    function fixAsideNav() {
        var offsetBottomWrapper = $('.layout .wrapper').offset().top + $('.layout .wrapper').outerHeight();
        var offsetBottomNav = $('.layout .aside-nav').offset().top + $('.layout .aside-nav').outerHeight();
        console.log($(window).scrollTop());
        console.log($('.aside-nav').offset().top);
        if ($(window).scrollTop() >= $('.layout').offset().top && !isSticky) {
        ...
        if (offsetBottomNav >= offsetBottomWrapper) {
            $('.aside-nav').removeClass('fixed');
        ...
        if ($(window).scrollTop() <= $('.layout').offset().top) {
            $('.aside-nav').removeClass('fixed');
            isSticky = false;
                ...
                for (var i in response.items) {
                  var to_insert_html =
                    '<div class="item">'+
                        ...
                        '</a>'+
                        '<p><span>'+response.items[i].name+'</span></p>'+
                        '<a href="'+response.items[i].link+'" class="btn">Подробнее</a>'+
                    '</div>';
